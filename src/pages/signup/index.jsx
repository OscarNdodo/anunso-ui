...
export default function SignUp() {
    ...
    const img = "/assets/images/cover.gif";
                ...
                <div className="max-w-screen-xl max-h-screen px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
                    <div className="grid grid-cols-1 gap-y-8  lg:items-center lg:gap-x-16">
                        <div className="flex flex-col">
                            <h2 className="text-3xl mulish-black uppercase mb-5 text-black/85 sm:text-4xl">Nova Conta</h2>
                                    ...
                                    (
                                        <div>
                                            ...
                                            <div className="col-span-6">
                                                <label htmlFor="Name" title="Nome completo do estudante ou instituicao" className="block text-base font-medium text-black/90"> Nome <span className="text-red-500 font-bold -ml-1">*</span> </label>

                                                <input
                                                    type="text"
                                                    placeholder="Zé Ninguém / Instituto Básico"
                                                    name="Name"
                                                    className="mb-2 w-full rounded-md outline-none border border-indigo-600 bg-white text-sm text-black/90 p-3 shadow-sm"
                                                />
                                            </div>
                            ...
                            <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                                ...
                                <p className="mt-4 text-sm text-gray-500 sm:mt-0">
                                    Já tens uma conta?
                                    <Link to="/login" className="text-black/90 underline"> Fazer login</Link>.
                                </p>
                            </div>
                        </div>
