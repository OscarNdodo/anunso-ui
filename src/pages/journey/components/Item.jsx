            ...
            <div className="w-full flex flex-col">
                ...
                {progress >= 0 && (
                    <div className="w-full flex mt-1">
                        ...
                        >
                            <span class="flex items-center justify-center w-full h-3 rounded-full bg-gradient-to-r from-purple-600 to-indigo-700 text-center text-xs" style={{ width: progress + "%" }}>
                                <span class="font-bold text-white text-[10px]  line-clamp-1"> {progress}%</span>
                            </span>
                        </span>
                    </div>
